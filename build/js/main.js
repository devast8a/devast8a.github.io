...
function createCanvas(width, height, z) {
...
window.addEventListener('DOMContentLoaded', async function () {
    ...
    class TmxRenderer {
        ...
        update(x, y) {
            ...
            if (Math.abs(uX - this.previousX) >= tile_margin ||
    ...
    load_rules();
    let previous = 0;
    function updateAnimatedTiles(time) {
    ...
    window.addEventListener('mousedown', (e) => {
        ...
        if (dictionaryOpen) {
            ...
            selectedTranslationText = (_a = simulation.player.dictionary.get(currentWord)) !== null && _a !== void 0 ? _a : "";
            return;
        }
        if (simulation.enableDictionary) {
            const left = animatedCanvas.width - 128;
